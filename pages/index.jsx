    ...
    <div className="max-w-3xl mx-auto pt-8">
      <div className="flex-1 mt-4 mb-6 p-4 rounded-lg">
        <p className="text-md leading-normal text-gray-700">
          ...
          join forces to respond to COVID-19.
        </p>
        <p className="text-md leading-normal text-gray-700">
          We've shown our capacity to build a distributed manufacturing network
          across Los Angeles and produce thousands of approved personal
        ...
        <p className="text-md leading-normal text-gray-700">
          Are you a maker who wants to bring your skills to the cause, a medical
          professional in need of support, or a community member who wants to
          make a difference? Join our fight by donating your time, materials, or
          funding to protect those on the frontlines of COVID-19.
        </p>
        <p className="text-md leading-normal text-gray-700">
          <b> By helping save their lives, we can help them save us all.</b>
        </p>
